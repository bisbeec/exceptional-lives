...
if ( !function_exists( 'skeleton_header_open' ) ) {
	...
	function skeleton_header_open() {
		echo "<div id=\"wrap\" class=\"container\">";
	  	echo "<div id=\"header\">\n<div id=\"widthWrapper\" class=\"flex fullHeight\">\n";
	}
...
if ( !function_exists( 'skeleton_logo' ) ) {
	...
	function skeleton_logo() {
			...
			if ( skeleton_options( 'logotype' ) ) :
				...
				$skeleton_logo .= '<a class="logotype-img logoWrap" href="'.esc_url( home_url( '/' ) ).'" title="'.esc_attr( get_bloginfo( 'name', 'display' ) ).'" rel="home">';
				$skeleton_logo .= '<img class="logo" src="'.skeleton_options( 'logotype' ).'" alt="'.esc_attr( get_bloginfo( 'name', 'display' ) ).'"></a>';
				$skeleton_logo .= '</h1>';
			// text
			else :
				$skeleton_logo  = '<h1 id="site-title">';
				$skeleton_logo .= '<a class="text logoWrap" href="'.esc_url( home_url( '/' ) ).'" title="'.esc_attr( get_bloginfo( 'name', 'display' ) ).'" rel="home">'.esc_attr( get_bloginfo( 'name', 'display' ) ).'</a>';
				$skeleton_logo .= '</h1>';
...
function skeleton_posted_on() {
	printf( __( '<span class="%1$s"></span> %2$s'),
